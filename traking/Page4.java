...
public class Page4 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String name=request.getParameter("name");
	       ...
	       ob.println("<form action='go4'  method='get'>");
	       ob.println("Hobbies <input type='text' name='h'><br>");
	       ob.println("Father's hobbies : <input type='text' name='fh'><br>");
	       ob.println("Mother's  hobbies : <input type='text' name='mh'><br>");
